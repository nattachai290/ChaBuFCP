...
public class OverViewAdapter  extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.i(MSG, "list: " + list);
        try {
            TextView tableId = (TextView) convertView.findViewById(R.id.list_view_over_view_table_id);
            tableId.setText(list.get("ListHdrId").get(position).toString());

            TextView tableNo = (TextView) convertView.findViewById(R.id.list_view_over_view_table_no);
            tableNo.setText(list.get("ListHdrTableNo").get(position).toString());

            TextView number_customer = (TextView) convertView.findViewById(R.id.list_view_over_view_table_cus);
            number_customer.setText("จำนวนลูกค้า : "+list.get("ListHdrCus").get(position).toString());

            TextView time = (TextView) convertView.findViewById(R.id.list_view_over_view_table_time);
